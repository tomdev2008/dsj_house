...
+function ($) {
  ...
  // ===================================
  $(document).on('change.dsj','.dsj_tag [type="checkbox"]',function (e) {
    // body...
    var value = $(this).val();
    if ($(this).prop('checked')) {
      var span = $('<span class="selected_tag" data-id="dsj_tag_'+value+'">'+$.trim($(this).parent().text())+'<span class="glyphicon glyphicon-remove" aria-hidden="true"></span></span>');
      span.data("value",value);
      $(this).closest('.dsj_tag').find('button').parent().append(span);
//      $('.dsj_tag button').parent().append(span)
  ...
  $(document).on('show.dsj','.dsj_tag [type="checkbox"]',function (e) {
    // body...
    var value = $(this).val();
    if ($(this).prop('checked')) {
      var span = $('<span class="selected_tag" data-id="dsj_tag_'+value+'">'+$.trim($(this).parent().text())+'<span class="glyphicon glyphicon-remove" aria-hidden="true"></span></span>');
...
//      $('.dsj_tag button').parent().append(span)
  ...
  $(document).on('click','.dsj_tag .glyphicon-remove',function (e) {
    // body...

    var value = $(this).parent().data("value");
    
    e.stopPropagation();
    $(this).closest('.dsj_tag').find('[type="checkbox"][value="'+value+'"]').prop("checked",false).change();
    $(this).parent().remove();
