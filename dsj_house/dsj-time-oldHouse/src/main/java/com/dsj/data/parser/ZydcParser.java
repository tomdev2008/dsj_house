...
public class ZydcParser {

	private final static Logger LOGGER = LoggerFactory.getLogger(ZydcParser.class);
	...
	@RequestMapping("list")
	public void fwList(Model model) {
	...
	private void jieXiUrl(int i, int x) {
	...
	private boolean startJx(int i, int x) throws Exception {
	...
	private HashMap<String, Object> detail(String url, String oldId) throws Exception {
	...
	private HashMap<String, Object> xiaoqu(String url, String oldId) throws Exception {
		HashMap<String, Object> hashMap = new HashMap<String, Object>();
