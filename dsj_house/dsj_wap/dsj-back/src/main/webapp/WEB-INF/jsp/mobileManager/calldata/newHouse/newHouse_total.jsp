		...
		<div class="white-head">
			<div class="row">
				<ul class="nav nav-tabs button_tab" role="tablist">
					<li role="presentation"><a href="${ctx }/back/frame/mobileManager/calldata/byNewHouse/newHouseYesterday">昨日新增</a></li>
					<li role="presentation"  class="active"><a href="javascript:void(0);">累计数据</a></li>
				</ul>
			</div>
			<div class="row">
...
<script type="text/javascript">
		...
		$("#search_btn").click(function(){
		 ...
		 $('#dataTable').DataTable( {
		     ...
		     /*    "bStateSave": true, */
		      ...
		      "bInfo": true,//页脚信息 
		      "iDisplayLength":10,
		      "sAjaxSource": _ctx+"/back/frame/mobileManager/calldata/byNewHouse/totalPageList",
		      "language": {
		      "lengthMenu": "",
		      "zeroRecords": "没有找到记录",
 ...
 function exportExcel(){
	 ...
	 location.href = _ctx+"/back/frame/mobileManager/calldata/byNewHouse/exportTotal?"+fromData 
 }
 </script>