		    ...
		    <div class="row">
		        <div class="col-xs-8 col-xs-offset-2">
					 ...
					 <div class="form-group">
			                ...
			                <c:forEach items="${serviceNames}" var="role" varStatus="status">
				                <c:if test="${role.isChecked == '1'}">
				                	<label><input name="serviceType" type="checkbox" value="${role.nameCode}" checked="checked" />${role.name}</label>
				                </c:if >
		            ...
		            <div class="form-group">
				        ...
				        <div class="col-sm-8">
				          <textarea rows="8" cols="35" name="introduce">${company.introduce }</textarea>
		             ...
		             <div class="text-center">
	                     <button class="btn btn-primary" type="button" onclick="editBusiness()">确认</button>
