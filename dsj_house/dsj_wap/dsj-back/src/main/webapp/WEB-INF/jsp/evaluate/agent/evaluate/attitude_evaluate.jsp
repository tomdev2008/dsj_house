	...
	<div class="white-head">
    	...
    	<form id="searchFromId" class="form-inline">
            ...
            <div class="form-group">
                ...
                <input type="text" class="small-input form-control" style="width: 45px;" name="minHighRate">%
             		至
                <input type="text" class="small-input form-control" style="width: 45px;" name="maxHighRate">%
            </div>
			<div class="form-group">
         		<span class="wenzi6">中评率:</span>
                <input type="text" class="small-input form-control" style="width: 45px;" name="minMidRate">%
             		至
                <input type="text" class="small-input form-control" style="width: 45px;" name="maxMidRate">%
            </div>
            <div class="form-group">
            	<span class="wenzi6">差评率分:</span>
                <input type="text" class="small-input form-control" style="width: 45px;" name="minDadRate">%
             		至
                <input type="text" class="small-input form-control" style="width: 45px;" name="maxBadRate">%
            </div>
 ...
 $(function(){
	...
	$("#search_btn").click(function(){
	 ...
	 $('#dataTable').DataTable({
		      ...
		      "bInfo": true,//页脚信息 
		      "iDisplayLength":10,
		      "sAjaxSource": _ctx + "/back/frame/newHouse/agentEvaluate/attitudeList",
		      "language": {
		      "lengthMenu": "",
		      "zeroRecords": "没有找到记录",
