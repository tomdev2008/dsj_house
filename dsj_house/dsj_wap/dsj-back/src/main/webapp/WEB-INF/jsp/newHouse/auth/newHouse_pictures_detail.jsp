								...
								<div id="bootstrap-wizard-1">
									<div class="tab-content mt30">
														...
														<div class="panel-body">
															<div class="dsj_img_wraper">
					 										...
					 										<p class="mt10" onclick="setDescribes(this)">
																<span>图片描述:${item.describes} ${item.pictureFrist}${item.pictureFrist}${item.pictureFrist}</span>
										...
										<div class="text-center">
						                     <button class="btn btn-primary" type="button" onclick="cancelFun('${history}')">返回相册</button>
						                </div>
									</div>
								</div>
							</form>
...
function cancelFun(type){
	$("#popup_box").show();
	if(type==''){
		location=_ctx+"/back/frame/newHouse/auth/newHouse_pictures_auth?newHouseId="+$("#newHouseId").val();
	}else{
		location=_ctx+"/back/frame/newHouse/auth/newHouse_pictures_history_auth?newHouseId="+$("#newHouseId").val();
	}
