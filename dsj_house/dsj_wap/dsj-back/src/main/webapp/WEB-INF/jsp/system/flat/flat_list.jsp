	...
	<div class="white-content">
		<div class="row">
			<div class="col-xs-12" style="padding-right:25px;">
				<shiro:hasPermission name='flat:add'>
					<button class="dsj_btn btn dsj_btn_green" type="button" onclick="addFlat()" style="width: 150px;">新建</button>
				</shiro:hasPermission>
				<shiro:hasPermission name='flat:deletes'>
					<button class="dsj_btn btn btn-default" type="button" onclick="delflats()">批量删除</button>
				</shiro:hasPermission>
				<!--表格 S-->
...
<script src="${ctx}/static/back/system/flat/flat_list.js"></script>