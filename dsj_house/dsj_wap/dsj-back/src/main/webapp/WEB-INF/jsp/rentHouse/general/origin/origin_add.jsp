				...
				<div class="row">
					<div class="col-xs-8 col-xs-offset-2">
							...
							<div class="col-sm-6">
								<c:choose>
									<c:when test="${empty rentOrigin.rentType }">
										<input name="rentType" type="radio" checked="checked" value="1">整租
										<input name="rentType" type="radio" value="2">合租
									</c:when>
									<c:otherwise>
										<input name="rentType" <c:if test="${rentOrigin.rentType eq 1}">checked="checked"</c:if> type="radio" value="1">整租
										<input name="rentType" <c:if test="${rentOrigin.rentType eq 2}">checked="checked"</c:if>type="radio" value="2">合租
									</c:otherwise>
								</c:choose>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="door" class="form-control dsj-inline dsj-width-1">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								房屋类型：<select name="wyType" class="form-control dsj-inline dsj-width-1">
								...
								装修状况：<select name="zxType" class="form-control dsj-inline dsj-width-1">
								...
								朝向：<select name="orientation" class="form-control dsj-inline dsj-width-1">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="houseFloor" value="${rentOrigin.houseFloor}" type="text" class="form-control dsj-inline dsj-width-1" data-validate="isNumber,required">楼 
							\ 共<input name="totalFloors" value="${rentOrigin.totalFloors}" type="text" class="form-control dsj-inline dsj-width-1" data-validate="isNumber,required">层
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">*房屋面积</label>
							<div class="col-sm-10">
								<input name="area" value="${rentOrigin.area}" type="text" class="form-control dsj-inline dsj-width-1" data-validate="required">
							</div>
						</div>
						<div class="form-group" id="genderType">
							<label class="col-sm-2 control-label">*性别限制</label>
							<div class="col-sm-10">
								<select name="genderType" class="form-control dsj-inline dsj-width-1">
							...
							<div class="col-sm-10">
								<c:forEach var="item" items="${houseDeployMap}">
									<label class="checkbox-inline">
										<input type="checkbox" name="detailPoint" onclick="validateName('detailPoint')" 
				...
				<div class="row">
					<div class="col-xs-8 col-xs-offset-2">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="rentPrice" value="${rentOrigin.rentPrice}" type="text" class="form-control dsj-inline dsj-width-1" data-validate="isPrice,required">元/月
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">*付款方式</label>
							<div class="col-sm-9">
								<select name="payType" class="form-control dsj-inline dsj-width-1">
				...
				<div class="row">
					<div class="col-xs-8 col-xs-offset-2">
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input name="houseTitle" value="${rentOrigin.houseTitle}" type="text" class="form-control" placeholder="推荐标语" data-validate="required">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">房源描述</label>
							<div class="col-sm-6">
								<textarea name="houseDesc" class="form-control">${rentOrigin.houseDesc}</textarea>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">*房源维护人</label>
							<div class="col-sm-6">
								<select id="agentUserSelect" class="form-control dsj-inline " name="agentUserSelect" class="js-example-basic-multiple"  data-validate="required">
