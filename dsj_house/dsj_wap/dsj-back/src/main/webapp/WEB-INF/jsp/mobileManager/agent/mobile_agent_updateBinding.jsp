						    ...
						    <div class="row">
						        <div class="col-xs-8 col-xs-offset-2">
						            ...
						            <div class="form-group">
						                ...
						                <div class="col-sm-6">
											  <input type="text" class="form-control" value="${mobilePo.agentName }" readonly="readonly">
						                </div>
						            </div>
						            <div class="form-group">
						                <label class="col-sm-2 control-label"><span style="color:red">*</span>经纪人编码:</label>
						                <div class="col-sm-6">
						                  <input type="text" class="form-control" name="agentCode" value="${mobilePo.agentCode }" readonly="readonly" id="agentCode">
						                </div>
						            </div>
						            <div class="form-group">
						    ...
						    <div class="row">
						        <div class="col-xs-8 col-xs-offset-2">
						            ...
						            <div class="form-group">
						                ...
						                <div class="col-sm-6">
						                  <input type="text" class="form-control" data-validate="required" placeholder="须为手机号,通话未成功时,挂机短信发送到该号码" name="msgPhone" value="${mobilePo.msgPhone }">
						                </div>
						            </div>
						    	</div>
						    </div>
	...
	$("#bindingForm").validate(function (result) {
	  	if(result){
	  		...
	  		$.ajax({
	  			...
	  			dataType:"json",
	  			url:_ctx+"/back/frame/mobileManager/agent/saveUpdateBinding",
