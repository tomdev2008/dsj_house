...
<div id="myModal" >
			<div class="modal-header">
    							 ...
    							 <form id="roleFrom" class="form-horizontal">
							          ...
							          <div class="form-group">
							           ...
							           <div class="form-group">
										    ...
										    <div class="col-sm-9">
										       <textarea rows="4" style="width:80%" id="comment" maxlength="30" placeholder="经纪人点评,最多可输入30字" data-validate="required">${pcAgent.comment}</textarea>
										    </div>
							          </div>
                       ...
                       <div class="modal-footer">
                           ...
                           <button type="button" name="confirm" class="dsj_btn btn dsj_btn_blue" onclick="updateAgentOldHosue()" id="add">确认</button>
                       </div>
                       </div>
