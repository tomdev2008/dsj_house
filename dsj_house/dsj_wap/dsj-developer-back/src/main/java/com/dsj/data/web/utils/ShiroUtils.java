...
public class ShiroUtils {
    ...
    public static UserPo getSessionUser(){
    	 return (UserPo) SecurityUtils.getSubject().getSession().getAttribute("sessionDeveloperUser");
    }

    public static void setSessionUser(Object admin){
        SecurityUtils.getSubject().getSession().setAttribute("sessionDeveloperUser",admin);
    }
