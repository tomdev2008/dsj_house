...
public class DynamicIpUtils {
	...
	public static void main(String[] args) {
		...
		String order = "06fa1d2b59c3977ae5ee2c10729b3620";
		// 你要抓去的目标网址
		String targetUrl = "https://bj.lianjia.com/ershoufang/101101114188.html";
		// 是否加载JS，加载JS会导致速度变慢
		boolean useJS = false;
		// 请求超时时间，单位毫秒，默认5秒
		int timeOut = 5000;
		...
		System.out.println("***************\n");
		DynamicIpUtils tester = new DynamicIpUtils();
