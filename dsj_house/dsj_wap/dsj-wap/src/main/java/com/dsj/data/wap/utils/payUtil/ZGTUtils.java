package com.dsj.data.wap.utils.payUtil;
...
public class ZGTUtils {
	...
	//配置文件路径
//	public static final String CONFIG_FILE_PATH	= "com/dsj/data/web/utils/payUtil/merchantInfo";
	...
	public static final String[] QUERYRECORDAPI_RESPONSE_HMAC_ORDER	= {"customernumber", "ledgerno", "status", "checkdate","reason"};
		
	//5.13 企业法人补充身份证认证接口请求及响应参数的hmac签名顺序
	public static final String[] IDCARDAUTHAPI_REQUEST_HMAC_ORDER 	= {"customernumber", "requestid", "ledgerno", "idcard"};
	public static final String[] IDCARDAUTHAPI_RESPONSE_HMAC_ORDER 	= {"customernumber", "requestid", "ledgerno", "code"};
	...
	private static String pcwebcallbackurl			= "";
	public static void setWapwebcallbackurl(String wapwebcallbackurl) {
		ZGTUtils.wapwebcallbackurl = wapwebcallbackurl;
	}

	private static String wapwebcallbackurl			= "";
...
//		merchantInfo	= Configuration.getInstance(CONFIG_FILE_PATH);
		//从配置文件中获取商户编号
		customernumber 	= ConfigUtils.instance.getCustomernumber();
		//从配置文件中获取商户密钥
		keyForHmac 		= ConfigUtils.instance.getKey();
		//aes密钥，为商户密钥的前16位
		keyForAes		= keyForHmac.substring(0, 16);
		
		callbackurl 	= ConfigUtils.instance.getCallbackurl();
		pcwebcallbackurl= ConfigUtils.instance.getPcwebcallbackurl();
		wapwebcallbackurl=ConfigUtils.instance.getWapwebcallbackurl();
		period 			= ConfigUtils.instance.getPeriod();
	...
	public static void setPeriod(String period) {
		ZGTUtils.period = period;
	}
	
	public static String getPcwebcallbackurl() {
		return pcwebcallbackurl;
	}

	public static void setPcwebcallbackurl(String pcwebcallbackurl) {
		ZGTUtils.pcwebcallbackurl = pcwebcallbackurl;
	}

	public static String getWapwebcallbackurl() {
