...
<link rel="stylesheet" href="${ctx}/static/front/css/popbox.css">
<div id="popup_box"  style="display:none">
<!-- 协议 -->
     <div class=" box_style box_agreement" style="display:none">
         <span class="box_closeagremet"></span>
    ...
    <div class="box_style box_affirm" style="display:none">
        ...
        <div class="box_kuang">
            <div class="box_title"> 
                <span id="confimMag">确定操作吗？</span>
            </div> 
            <form>
            <div class=" buttons">
                    <button type="reset" id="cancelBtn" class="btn reset_botton">取消</button>    
                    <button type="button" id="confimYes" class="btn submit_botton">确认</button>
                </div>  
            </form>
        </div>
    </div> 
    <div class=" box_style box_defeated" style="display:none">
        ...
        <div class="box_kuang">
            <div class="box_title "> 
                <span id="failMsg">很抱歉，提交失败，请稍后再试</span>
            </div> 
            <form>
                <div class=" buttons">    
                    <button type="button" class="btn submit_botton">确认</button>
                </div>  
            </form>
        </div>
    </div>
    ...
    <div class=" box_style refund_cause user_back_kuang" style="display:none">
            <span class="box_close"></span>
            <div class="refund_kuang " >
                <h4>用户反馈</h4>
                <div class="refund_form warrant_form_kuang">
                <!-- form -->
                  <form>
                        <div class="f_cendiv">
                            <div class="select_kind">
                                <div class="textarea_kuang">
                                    <div class="select_kind">
                                        <textarea class="form-control" onkeyup="wordNum()" rows="4" maxLength="300" id="advice" placeholder="请在这里写下您的建议或问题"></textarea>
                                        <div class="residue_words"><span class="hint_words"></span>您可以输入<span id="word_300">300</span>个字</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="btn_kuang">
                            <button type="button" id="submitButtton" class="btn pay_btn">提交</button>
                        </div>
                  </form>
                </div>
            </div>
      ...
      <!-- 退款原因 -->
    <div class=" box_style refund_cause refund_reason" style="display:none">
        <span class="box_close"></span>
        <div class="refund_kuang ">
            <h4>请选择退款原因</h4>
            <div class="refund_form warrant_form_kuang">
                    ...
                    <div class="f_cendiv">
                        <div class="select_kind">
                            <label class="label_active">
                              <input type="radio" name="inlineRadioOptions" id="inlineRadio1" checked="checked" value="重复下单">重复下单
                            </label>
                            <label>
                              <input type="radio" name="inlineRadioOptions" id="inlineRadio2" value="误下单">误下单
                            </label>
                            <label >
                              <input type="radio" name="inlineRadioOptions" id="inlineRadio3" value="不想买了">不想买了
                            </label>
                             <label >
                              <input type="radio" name="inlineRadioOptions" id="inlineRadio4" value="服务不满意">服务不满意
                            </label>
                            <label >
                              <input type="radio" name="inlineRadioOptions" id="inlineRadio5" value="其它原因">其它原因
                            </label>
                            <div class="textarea_kuang">
                                <div class="select_kind">
                                    <textarea id = "refund_text_1"  onkeydown="checkNum(this,15)"  
								            onkeyup="checkNum(this,15)" onfocus="checkNum(this,15)" 
								            onblur="checkNum(this,15);" maxlength="15" class="form-control" rows="4" placeholder="其他原因："></textarea>
                                    <div class="residue_words"><span class="hint_words">*退款申请一经提交后不可撤销  <span id="mastTaxt">请填写必要内容</span></span>您可以输入<span class="textNum">15</span>个字</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="btn_kuang">
                        <button id="tuikuanBtn" type="button" class="btn btn-primary pay_btn ">提交</button>
                    </div>
              </form>
            </div>
        </div>
    ...
    <!-- 登录  -->
    <div class=" box_style popbox_login"  style="display:none">
                <div class="box_login">用户登录</div>
                <span class="box_close"></span>
                <!-- 登录框 -->
...
<script>
 	var user="<#if Session.pc_user_session??>${Session.pc_user_session}</#if>";
	function checkLogin(){
		$.ajax({
	  		type:"post",
	  		async: false,
 ...
 <script>  
    ...
    box_feedback = ".user_back_kuang",//4
    box_refund = ".refund_reason",//5
    box_login = ".popbox_login";   //7
   	...
   	$(".box_closeagremet").on("click",function(event){
        $(".box_agreement").hide();
        event.stopPropagation(); 
