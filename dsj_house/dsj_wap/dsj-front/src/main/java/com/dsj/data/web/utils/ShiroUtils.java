...
public class ShiroUtils {
    ...
    public static UserPo getSessionUser(){
    	 return (UserPo) SecurityUtils.getSubject().getSession().getAttribute("sessionAgentUser");
    }

    public static void setSessionUser(Object admin){
        SecurityUtils.getSubject().getSession().setAttribute("sessionAgentUser",admin);
    }
