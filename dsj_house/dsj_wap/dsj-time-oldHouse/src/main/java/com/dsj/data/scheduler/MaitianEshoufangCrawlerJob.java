...
public class MaitianEshoufangCrawlerJob  implements Runnable {
	...
	@Override
	public void run() {
		System.out.println("maitianErshoufangCrawlerJob activityJob:");
		
		maitianBiz.runPageJob();
	}
