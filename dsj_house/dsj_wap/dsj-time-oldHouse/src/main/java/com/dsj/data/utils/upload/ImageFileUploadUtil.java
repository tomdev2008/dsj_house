package com.dsj.data.utils.upload;
...
public class ImageFileUploadUtil {
	 ...
	 */
	public static String uploadImageFile(OSSClient OC,String fileRoot,File file,String imagePathFileName ,String imageInfoPath,String oss_bucket)  {
		if (file != null) {
			try {
				// 需要修改文件的后缀名称
				...
				String md5key = OSSUnit.uploadObject2OSS(OC, file, oss_bucket,imagePathFileName);
