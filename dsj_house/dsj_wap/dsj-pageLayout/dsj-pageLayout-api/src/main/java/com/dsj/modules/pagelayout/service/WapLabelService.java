 ...
 * @版本: 1.0 .
 */
public interface WapLabelService extends BaseService<WapLabelPo>{
	List<String> getTypeGroup();

	List<LabelTypeVo> getType();
	
	List<WapLabelVo> getNewList(List<WapLabelPo> list);
	
	List<WeightAndTypeVo> getWeightAndTypeVo(String types,String weights,int page);
