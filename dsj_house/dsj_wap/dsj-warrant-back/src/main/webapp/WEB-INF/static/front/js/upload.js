...
//二手房房源
function successOldMasterUpload(arr,pictureType,oldMasterId){
	...
	$.ajax({
		...
		dataType:"json",
		url:_url+"/back/oldHouse/master/update_master_image",
...
function uploadImage(wrapper,filePicker,pictureType,objId ){
    ...
    function setState( val ) {
        ...
        switch ( state ) {
            ...
            case 'finish':
                ...
                if ( stats.successNum ) {
                   // alert( '上传成功' );
                    successOldMasterUpload(arr,pictureType,objId);
                    reader(arr);
                    arr=new Array();
                } else {
                    // 没有成功的图片，重设
