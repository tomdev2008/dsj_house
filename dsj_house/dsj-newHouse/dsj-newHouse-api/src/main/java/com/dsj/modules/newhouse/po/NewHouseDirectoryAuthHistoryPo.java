 ...
 * @版本: 1.0 .
 */
public class NewHouseDirectoryAuthHistoryPo extends BaseEntity {
	
	private static final long serialVersionUID = 1L;
	
	private Long edit;		// 楼盘列表展示的数据 1展示数据 2 不展示的数据(已上架的修改后数据)
	...
	private Long status;		// 销售状态 1待售 2在售 3售完
	...
	private Integer isTure;		// 是否上架(包含已删除)1未上架 2已上架 3已下架 4已删除
	private Integer authStatus;		// 审核状态1待提交 2待审核 3通过 4拒绝
	...
	public NewHouseDirectoryAuthHistoryPo() {
		super();
	}

	public NewHouseDirectoryAuthHistoryPo(Long id){
		this();
	}
