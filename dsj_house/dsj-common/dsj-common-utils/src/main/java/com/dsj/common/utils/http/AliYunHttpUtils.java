...
public class AliYunHttpUtils {
    ...
    protected static  final Logger logger = LoggerFactory.getLogger(AliYunHttpUtils.class);
    ...
    public static String getIpInfo(String ip)
    {
        ...
        headers.put("Authorization", "APPCODE 7f7d2a2fb59f41d8b81cbe696e78189b");
        ...
        try {
            ...
            logger.warn(CommConst.ERROR_MSG, e);
        }
        return null;
    }
    ...
    {
        System.out.println(getIpInfo("49.4.137.51"));
    }
}
