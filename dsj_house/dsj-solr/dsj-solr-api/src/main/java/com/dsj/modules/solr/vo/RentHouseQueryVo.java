...
public class RentHouseQueryVo implements Serializable {
	...
	private Integer wyType;		//物业类型
	
	private Integer payType;	// 付款方式
	private Integer rentType;	// 租房类型
	...
	private Integer amn;//价格最小
	private Integer amx;//价格最大
