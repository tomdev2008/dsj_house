	...
	<div class="white-head">
		<div class="row">
			...
			<form class="form-horizontal dsj_house_tab_form" novalidate="novalidate" style="margin-top:50px;">
					<div class="col-xs-12">
					         <button class="dsj_btn btn dsj_btn_green" type="button" onclick="addHouseType(${newHouseId})">新增户型</button>
					          <button class="dsj_btn btn btn-default" type="button" onclick="delNewHouseType(${newHouseId})">删除</button>
					          <button class="dsj_btn btn btn-default" type="button" onclick="selectAll()">全选</button>
					</div>
							           ...
							           <c:if test="${houseTypeList1 != null}">
							             <c:forEach items="${houseTypeList1}" var="layoutType">
							               <div class="col-xs-3">
														...
														<input class="dsj_pic_checkbox" type="checkbox" value="${layoutType.id}" name="layoutName">
															...
															<a href="javascript:void(0)" onclick="findOneLayOut(${layoutType.id });"><img class="img-rounded img-responsive" alt="Responsive image" src="${layoutType.imgUrl}"></a>
																...
																<p class="mt10">
																	<span>
																	<c:if test="${layoutType.builtUp !=null}">
																	建筑面积:${layoutType.builtUp}
																	</c:if>
																	</span>
	                ...
	                <div class="row">
                           <div class="col-xs-4 col-xs-offset-4 text-center dsj_bottom_button">
                            <button type="button" class="btn btn-primary" onclick="submitAddNewHouse(${newHouseId});" id="submitId">提交</button>
                           <button type="button" class="btn btn-default" onclick="cancelLayout();">暂不提交</button>
                           <button class="btn btn-primary" type="button" onclick="toBackPhoto(${newHouseId});">上一步</button>
                          </div>
                       </div>
	                </form>
	        </div>
...
function toBackPhoto(id){
	location = _ctx+"/back/frame/newHouse/edit/newHouse_pictures_add?newHouseId="+id;
}
</script>
<script src="${ctx}/static/back/newHouse/edit/newHouse_houseType.js"></script>