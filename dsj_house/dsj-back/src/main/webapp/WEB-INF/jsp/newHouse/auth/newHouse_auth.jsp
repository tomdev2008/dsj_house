									...
									<div class="form-group form-inline" id="subwayDiv">
						                ...
						                <c:if test="${status.index==0}">
							                <div class="col-sm-10">
												...
												<select id="line${status.index}" class="form-control dsj-inline dsj-width-1">
													<option value="">${subways.lineName }</option>
												</select>
												<span class="wenzi6">站点:</span>
												<select id="station${status.index}" class="form-control dsj-inline dsj-width-1">
													<option value="">${subways.stationName }</option>
												</select>
				        ...
				        <div class="col-xs-8 col-xs-offset-2">
				            ...
				            <div class="form-group">
				             ...
				             <div class="text-center">
			                     <button class="btn btn-primary" type="button" onclick="nextPage('${history}')">下一步</button>
			                </div>
				        </div>
				    </div>
				</form>
...
function nextPage(type){
	$("#popup_box").show();
	if(type==''){
		location=_ctx+"/back/frame/newHouse/auth/newHouse_pictures_auth?newHouseId="+$("#houseId").val();
	}else{
		location=_ctx+"/back/frame/newHouse/auth/newHouse_pictures_history_auth?newHouseId="+$("#houseId").val();
	}
