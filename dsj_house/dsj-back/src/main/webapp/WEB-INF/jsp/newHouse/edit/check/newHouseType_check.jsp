...
<div class="col-xs-12 padding-foot">
					...
					<div class="row">
						...
						<div class="btngroup row mt20 text-center">
		                     <button class="btn btn-default" onclick="cancelLayout()" type="button">返回</button>
		                </div>
					</div>
				</div>
<script>
...
function cancelLayout(){
	$("#popup_box").show();
	location=_ctx+"/back/frame/newHouse/edit/newHouse_check_houseTypeList?newHouseId=${newHouseId}";
}
</script>