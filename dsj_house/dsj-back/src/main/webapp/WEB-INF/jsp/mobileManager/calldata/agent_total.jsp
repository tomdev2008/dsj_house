		...
		<div class="white-head">
			<div class="row">
				<ul class="nav nav-tabs button_tab" role="tablist">
					<li role="presentation"><a href="${ctx }/back/frame/mobileManager/calldata/byAgent">昨日新增</a></li>
					<li role="presentation" class="active"><a href="${ctx }/back/frame/mobileManager/calldata/byAgent/agentTotal">累计数据</a></li>
				</ul>
			</div>
...
<script type="text/javascript">
		...
		$("#search_btn").click(function(){
		 ...
		 $('#dataTable').DataTable( {
		     ...
		     /*    "bStateSave": true, */
		      ...
		      "bInfo": true,//页脚信息 
		      "iDisplayLength":10,
		      "sAjaxSource": _ctx+"/back/frame/mobileManager/calldata/byAgent/totalPageList",
		      "language": {
		      "lengthMenu": "",
		      "zeroRecords": "没有找到记录",
 ...
 function exportExcel(){
	...
	//}else{
	 	...
	 	location.href = _ctx+"/back/frame/mobileManager/calldata/byAgent/exportAgentTotal?"+fromData; 
	//}
 }
