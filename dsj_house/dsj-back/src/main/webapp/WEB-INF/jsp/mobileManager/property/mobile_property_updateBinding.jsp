						        ...
						        <div class="col-xs-8 col-xs-offset-2">
						            <div class="form-group">
						                ...
						                <div class="col-sm-6">
						                  ...
						                  <input type="hidden" class="form-control" name="type" value="${mobilePo.type }">
						            ...
						            <div class="form-group">
						                ...
						                <div class="col-sm-6">
											  <input type="text" class="form-control" name="propertyName" value="${mobilePo.propertyName }" readonly="readonly">
						                </div>
						            </div>
						            <div class="form-group">
						                <label class="col-sm-2 control-label"><span style="color:red">*</span>代办人ID:</label>
						                <div class="col-sm-6">
						                  <input type="text" class="form-control" name="propertyId" value="${mobilePo.propertyId }" readonly="readonly" id="propertyId">
						                </div>
						            </div>
						            <div class="form-group">
	...
	$("#bindingForm").validate(function (result) {
	  	if(result){
	  		...
	  		$.ajax({
	  			...
	  			dataType:"json",
	  			url:_ctx+"/back/frame/mobileManager/property/saveUpdateBinding",
