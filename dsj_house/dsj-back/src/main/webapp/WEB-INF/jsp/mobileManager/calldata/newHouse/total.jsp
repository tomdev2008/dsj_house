		...
		<div class="white-head">
			<div class="row">
				<ul class="nav nav-tabs button_tab" role="tablist">
					<li role="presentation"><a href="${ctx }/back/frame/mobileManager/calldata/newHouse/yesterday">昨日新增</a></li>
...
<script type="text/javascript">
		...
		$("#search_btn").click(function(){
		 ...
		 $('#dataTable').DataTable( {
		     ...
		     /*    "bStateSave": true, */
		      ...
		      "bInfo": true,//页脚信息 
		      "iDisplayLength":10,
		      "sAjaxSource": _ctx+"/back/frame/mobileManager/calldata/newHouse/totalPage/list",
		      "language": {
		      "lengthMenu": "",
		      "zeroRecords": "没有找到记录",
 ...
 function exportExcel(){
	 ...
	 location.href = _ctx+"/back/frame/mobileManager/calldata/newHouse/exportTotal?"+fromData 
 }
 </script>