		...
		<div class="white-head">
			<div class="row">
				<ul class="nav nav-tabs button_tab" role="tablist">
					...
					<li role="presentation" class="active"><a href="${ctx }/back/frame/mobileManager/detail/mobile_agent_list">经纪人来电明细</a></li>
...
function exportExcel(){
	 ...
	 location.href = _ctx+"/back/frame/mobileManager/detail/exportAgent?"+fromData 
}
 $(function(){
	 setLayDateOne();
		var userManage = {
