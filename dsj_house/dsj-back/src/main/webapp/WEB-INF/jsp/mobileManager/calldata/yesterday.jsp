		...
		<div class="white-head">
			<div class="row">
				<ul class="nav nav-tabs button_tab" role="tablist">
					<li role="presentation" class="active"><a href="${ctx }/back/frame/mobileManager/calldata/agent">昨日新增</a></li>
					<li role="presentation"><a href="${ctx }/back/frame/mobileManager/calldata/agent/total">累计数据</a></li>
				</ul>
			</div>
...
<script type="text/javascript">
		...
		$("#search_btn").click(function(){
		 ...
		 $('#dataTable').DataTable( {
		     ...
		     /*    "bStateSave": true, */
		      ...
		      "bInfo": true,//页脚信息 
		      "iDisplayLength":10,
		      "sAjaxSource": _ctx+"/back/frame/mobileManager/calldata/agent/page/list",
		      "language": {
		      "lengthMenu": "",
		      "zeroRecords": "没有找到记录",
 ...
 function exportExcel(){
	...
	//}else{
	 	...
	 	location.href = _ctx+"/back/frame/mobileManager/calldata/agent/exportYesterday?"+fromData; 
	//}
 }
 </script>
