		...
		<div class="white-head">
			<div class="row">
				<ul class="nav nav-tabs button_tab" role="tablist">
					<li role="presentation"><a href="${ctx }/back/frame/mobileManager/calldata/agent">昨日新增</a></li>
					<li role="presentation" class="active"><a href="${ctx }/back/frame/mobileManager/calldata/agent/total">累计数据</a></li>
				</ul>
			</div>
...
<script type="text/javascript">
		...
		$("#search_btn").click(function(){
		 ...
		 $('#dataTable').DataTable( {
		     ...
		     /*    "bStateSave": true, */
		      ...
		      "bInfo": true,//页脚信息 
		      "iDisplayLength":10,
		      "sAjaxSource": _ctx+"/back/frame/mobileManager/calldata/agent/totalPage/list",
		      "language": {
		      "lengthMenu": "",
		      "zeroRecords": "没有找到记录",
 ...
 function exportExcel(){
	//if($("#LAY_demorange_ss_one").val()==''&&$("#LAY_demorange_ee_one").val()==''){
	//	setErrorContent("请选择需要导出的数据");
	//}else{
	 	var fromData=serializeForm("searchFromId");
	 	location.href = _ctx+"/back/frame/mobileManager/calldata/agent/exportTotal?"+fromData; 
	//}
 }
 </script>