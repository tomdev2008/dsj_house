		...
		<div class="white-head">
			<div class="row">
				<ul class="nav nav-tabs button_tab" role="tablist">
					<li role="presentation"><a href="${ctx }/back/frame/mobileManager/detail">楼盘来电明细</a></li>
					<li role="presentation"><a href="${ctx }/back/frame/mobileManager/detail/mobile_agent_list">经纪人来电明细</a></li>
					<li role="presentation" class="active"><a href="${ctx }/back/frame/mobileManager/detail/mobile_property_list">代办人来电明细</a></li>
				</ul>
			</div>
			     <form id="searchFromId" class="form-inline">
	                	...
	                	<div class="form-group mr20">
	                	 ...
	                	 <div class="form-group mr20">
		                	<span class="wenzi6">代办人编码:</span>
		                    <input type="text" class="small-input form-control" placeholder="代办人编码" name="propertyCode">
		                </div>
			    		 <div class="form-group mr20">
		            ...
		            "aoColumns" : [ {
		        		...
		        		"aTargets" : [ 3 ]
		                  ...
		                  "mRender":function(data,type,full){
		                	  ...
		                	  var down = "<a class='dsj_btn btn btn-default' href='javascript:void(0);' onclick=\""+str+"\">下载</a>";
			                	return down;
		                  }
	                }
		        	]
