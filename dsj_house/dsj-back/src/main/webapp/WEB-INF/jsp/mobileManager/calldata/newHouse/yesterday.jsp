		...
		<div class="white-head">
			<div class="row">
				<ul class="nav nav-tabs button_tab">
					...
					<li role="presentation"><a href="${ctx }/back/frame/mobileManager/calldata/newHouse/total">累计数据</a></li>
				</ul>
			</div>
			<div class="row">
...
<script type="text/javascript">
	 ...
	 setLayDateThree();
		...
		$("#search_btn").click(function(){
		 ...
		 $('#dataTable').DataTable( {
		      ...
		      "bInfo": true,//页脚信息 
		      "iDisplayLength":10,
		      "sAjaxSource": _ctx+"/back/frame/mobileManager/calldata/newHouse/page/list",
		      "language": {
		      "lengthMenu": "",
		      "zeroRecords": "没有找到记录",
 ...
 function exportExcel(){
	 ...
	 location.href = _ctx+"/back/frame/mobileManager/calldata/newHouse/exportYesterday?"+fromData 
 }
 </script>
