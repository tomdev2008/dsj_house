...
<div class="white-head">
	 <h1 class="page-title txt-color-blueDark">
		...
		<div class="row">
			   <button class="dsj_btn btn dsj_btn_green" type="button">昨日新增</button>
			   <button class="dsj_btn btn btn-default" type="button" onclick="historyList()">累计数据</button>
		</div> 
			     <form id="searchFromId" class="form-inline">
			     		<div class="form-group mt20">
			    		   ...
			    		   <span class="wenzi6">至</span>
		                    ...
		                    <input type="text" class="small-input form-control" id="name" placeholder="模糊匹配" name="name">
		                     <span class="wenzi6">手机号:</span>
		                    <input type="text" class="small-input form-control" id="phone" maxlength="11" name="phone">
		                     
		              	 
			            </div>
			            <div class="form-group mt20">
			            	<span class="wenzi6">公司:</span>
		                    <input type="text" class="small-input form-control" maxlength="20" id="companyName" placeholder="公司(不超过20个字)" name="companyName">
 ...
 $(function(){
	 ...
	 var yesterdsay = new Date(new Date().getTime() - 86400000).format('yyyy-MM-dd');
	 $("#LAY_demorange_zs").attr("placeholder",yesterdsay);
	 $("#LAY_demorange_ze").attr("placeholder",today);
		...
		$("#search_btn").click(function(){
		 ...
		 $('#dataTable').DataTable( {
		     ...
		     /*    "bStateSave": true, */
		      ...
		      "bInfo": true,//页脚信息 
		      "iDisplayLength":10,
		      "sAjaxSource": _ctx+"/back/frame/agentStatistic/yesterdayData",
		      "language": {
		      "lengthMenu": "",
		      "zeroRecords": "没有找到记录",
 ...
 function historyList(){
	 window.location = _ctx+"/back/frame/agentStatistic/statisticsList";
 }
 function export1(){
	 var fromData=serializeForm("searchFromId");
	 location.href = _ctx+"/back/frame/agentStatistic/yesterdayExport?"+fromData 
