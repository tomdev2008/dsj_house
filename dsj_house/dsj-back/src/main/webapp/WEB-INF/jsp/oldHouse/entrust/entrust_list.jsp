	...
	<div class="white-head">
		...
		<form id="searchFromId" class="form-inline">
			...
			<div class="form-group mr20">
				...
				<input type="text" maxlength="25" class="small-input" placeholder="小区名称查询" name="buildingName"  style="width: 100px;">
			</div>
...
<script src="${ctx}/static/back/oldHouse/entrust/entrust_list.js"></script>