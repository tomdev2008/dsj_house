 ...
 * @版本: 1.0 .
 */
public class HouseAlikeCommunityPo extends BaseEntity {
	...
	public HouseAlikeCommunityPo() {
		super();
	}

	public HouseAlikeCommunityPo(Long id){
		this();
	}
	...
	public String toString() {
		return "HouseAlikeCommunityPo [name=" + name + ", nickName=" + nickName + ", averagePrice=" + averagePrice
				+ ", builtYear=" + builtYear + ", buildingType=" + buildingType + ", buildingNum=" + buildingNum
				+ ", houseTypeNum=" + houseTypeNum + ", saleNumber=" + saleNumber + ", propertyFee=" + propertyFee
				+ ", propertyCompany=" + propertyCompany + ", totalHouse=" + totalHouse + ", store=" + store
				+ ", originCommunityId=" + originCommunityId + ", developer=" + developer + ", accuracy=" + accuracy
				+ ", dimension=" + dimension + ", resblockPosition=" + resblockPosition + ", pageUrl=" + pageUrl
				+ ", company=" + company + ", lianjiaId=" + lianjiaId + ", areaCode1=" + areaCode1 + ", areaName1="
				+ areaName1 + ", areaCode2=" + areaCode2 + ", areaName2=" + areaName2 + ", areaCode3=" + areaCode3
				+ ", areaName3=" + areaName3 + ", tradingAreaId=" + tradingAreaId + ", tradingAreaName="
				+ tradingAreaName + ", builtUp=" + builtUp + ", heatingMode=" + heatingMode + ", heatingModeName="
				+ heatingModeName + ", houseNum=" + houseNum + ", plotRatio=" + plotRatio + ", greenRate=" + greenRate
				+ ", parkingSpace=" + parkingSpace + ", occupyArea=" + occupyArea + ", address=" + address + "]";
	}
