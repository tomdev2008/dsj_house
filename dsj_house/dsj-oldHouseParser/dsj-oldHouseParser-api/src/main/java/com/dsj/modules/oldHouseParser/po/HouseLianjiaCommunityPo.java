 ...
 * @版本: 1.0 .
 */
public class HouseLianjiaCommunityPo extends BaseEntity {
	...
	public HouseLianjiaCommunityPo() {
		super();
	}

	public HouseLianjiaCommunityPo(Long id){
		this();
	}
