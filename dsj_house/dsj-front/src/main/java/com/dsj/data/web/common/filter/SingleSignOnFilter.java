...
public class SingleSignOnFilter implements Filter {
	...
	static Logger LOGGER = LoggerFactory.getLogger(SingleSignOnFilter.class);
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
		...
		String url = request.getRequestURI();
			...
			if (req instanceof HttpServletRequest && res instanceof HttpServletResponse) {
				...
				LOGGER.info("loginCustomer："+session.getAttribute(BusinessConst.PC_USER_SIESSION));
				if (null == session.getAttribute(BusinessConst.PC_USER_SIESSION)) {
