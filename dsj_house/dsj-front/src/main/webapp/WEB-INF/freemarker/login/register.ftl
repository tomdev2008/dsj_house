                    ...
                    <form class="form-inline">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control ursname ursnameCode" id="phone" placeholder="请输入手机号">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" id="code" class="form-control verifyCode" id="verification_label" placeholder="请输入验证码">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="password" class="form-control passwordCode2" id="password" placeholder="6至20位的字母、数字、下划线">
                                <div class="showText">
                        ...
                        <!-- 确认 -->
                        <button type="button" class="login_botton countersign">确认</button>
                        <!-- 用户协议 -->
                        <div class="checkbox autoRegister userAgreement">
                            <label class="check_yess">
                                <input type="checkbox" id="userProtocol"> 我已经阅读
                    
                            </label>
                            <a onclick="showUserProtocol()" style="height: 20px;line-height: 20px;vertical-align: text-bottom;">用户协议</a>
                            <p>已有账号，去<a href="${ctx}/login/tologin">登录</a></p>
                        </div>
                    </form>
                    <!-- 经纪人登录开发商登录 -->
        ...
        <script type="text/javascript">
            ...
            function checkPassword(){
                ...
                if(!myreg.test(password)||password.length>20){
                    showErrorMsg("密码为6至20位的字母、数字、下划线");
                    return false;
                }else{
                    return true;
                }
            ...
            $(".verifyCodeButton").on("click",function(){
            	var _this = $(this);
              	...
              	if(!checkPhone()){
                    ...
                    $.ajax({
                        type:"post",
                        url:_ctx+"/login/send_register_vcode",
                        dataType:"json",
            ...
            $(".countersign").on("click",function () {
            	...
            	if(code!=null&&code!=''){
                 	...
                 	if($("#userProtocol").is(':checked')==false){
        	           	showErrorMsg("请阅读用户协议");
                   		return 
                    }
            		$.ajax({
                    type:"post",
                    url:_ctx+"/login/register_passsword_verify",
                    dataType:"json",
                    data:{"phone":$("#phone").val(),"code":code,password:$("#password").val()},
                    success:function(data){
                        if(data.status == 200){
                        	show_box(3,"注册成功，3秒后返回登录页面");
                        	setTimeout(function(){
                        		window.location=_ctx+"/login/tologin";
                        	},3000);
